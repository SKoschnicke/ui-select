...
app.controller('DemoCtrl', function ($scope, $http, $timeout, $interval) {
  ...
  var i;
  var multiplied_countries = [];
  for (i = 0; i < 2; i++) {
    var new_countries = vm.countries.map(function(e) { return {name: e.name + " " + i, code: e.code + " " + i}});
    multiplied_countries = multiplied_countries.concat(new_countries);
  }
  vm.countries = multiplied_countries;
});
